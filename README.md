...
# Detaylar
    ...
    Yapı:         sutsurup tarafından Clover Bootloader kullanılarak ASUS K555UB cihaza uyarlanmıştır
...
# Desteklenmeyen donanımlar
    ...
    3. ELAN1000 Touchpad [Yama yapıldı - çalışıyor]
    4. Realtek RTL8723BE Wireless (Wi-Fi kartı) [Apple desteklemiyor] -Yazının devamında çözümü var-

## Uyumluluk
Paylaştığım EFI klasörü, **macOS Catalina 10.15.7** sürümüne kadar desteklenmektedir.
...
1. BIOS ekranına girin ve aşağıdaki değerleri değiştirin (ESC tuşu BIOS menüsüne girmeye yardımcı olur):
	...
	- Display memory: 64MB
	- Intel® Virtualization Technology devre dışı bırakın.
	- Secure Boot devre dışı bırakın.
...
K555UB sistemiyle yerleşik gelen Realtek RTL8723BE Wireless kartı Apple tarafından **desteklenmediğinden dolayı,** bu kartı değiştirmeniz gerekiyor. Peki bu konuda ne yapabiliriz?
...
2. Kurulum dosyasını indirdikten sonra kurulumu tamamlayın. 
